...
<head>
    ...
    <link rel="icon" href="assets/rajhighgardens/images/favicon.png" sizes="32x32" />
    <link rel="icon" href="assets/rajhighgardens/images/favicon.png" sizes="192x192" />
    <link rel="apple-touch-icon" href="assets/rajhighgardens/images/favicon.png" />
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="assets/rajhighgardens/css/bootstrap.min.css">
    <link rel="stylesheet" href="https://kit.fontawesome.com/b6a944420c.css" crossorigin="anonymous">
    <link rel="stylesheet" href="assets/rajhighgardens/css/slick.css">
    <link rel="stylesheet" href="assets/rajhighgardens/css/tabs.css">
    <link rel="stylesheet" href="assets/rajhighgardens/css/iziToast.min.css">
...
<body>
    <header>
        <nav>
            <div class="logo-holder">
                <a href="">
                    <img src="assets/rajhighgardens/images/snn-raj-corp-logo.png" class="main-logo top-logo" alt="">
                </a>
            </div>
        </nav>
    </header>
                ...
                <div id="tophighlights">
                    ...
                    <div id="topform" class="formbackground" style="background-color: #F7F2EC;background-image: unset;">
                        ...
                        <div
                            ...
                            <h1 class="mb8 text-center" style="color:#1C1919;"><b>Raj Viviente by SNN Corp @ 3.9Cr*</b>
                            </h1>
                            <h1 class="mb16 text-center" style="    line-height:24px;color:#1C1919;"><b
                                    style="font-size:14px;    font-weight: 400;">Located Off Bannerghatta Road - South
                                    Bangalore</b></h1>
                        </div>
                        <ul>
                            <li style="font-weight:700;"><span style="color: #3D833E;">➤</span> Ultra Luxury 4BHK(G+2)
                                Villas + Pvt. Garden</li>
                            <li style="font-weight:700;"><span style="color: #3D833E;">➤</span> 3891 Sqft Villas Just
                                Off Bannerghatta Rd</li>
                            <li style="font-weight:700;"><span style="color: #3D833E;">➤</span> 5 Mins To Royal
                                Meenakshi Mall & Decathlon</li>
                            <li style="font-weight:700;"><span style="color: #3D833E;">➤</span> 10 Mins From IIM, Fortis
                                & Apollo Hospitals</li>
                            <li style="font-weight:700;"><span style="color: #3D833E;">➤</span> 64 Exclusive G+2 Villas
                                Across 5.5 Acres</li>

                            <li style="font-weight:700;"><span style="color: #3D833E;">➤</span> Ultra Modern Clubhouse &
                                20+ Amenities</li>

                            <li style="font-weight:700;"><span style="color: #3D833E;">➤</span> Double Height Ceiling &
                                18 Ft. Tall Windows</li>

                            <li><span style="color: #3D833E;">➤</span>Project By The Prestigious SNN Raj Corp</li>
                        </ul>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-12 content-holder">
                        ...
                        <p><b>Overview</b> : Raj Viviente by SNN Corp offers 64 Ultra Luxury 4BHK(G+2 Floors) Villas
                            With Private Backyard Garden Off Bannerghatta Road Near Nice Rd Junction in South Bangalore.
                            The 3891 Sqft lavish villas feature double height ceilings, 18 feet tall windows, 2 covered
                            car parkings, provision for elevator & much more.
                        </p>
                        <p>
                            <b>Location</b> : Raj Viviente is located Off Bannerghatta Road Near Nice Rd Junction in
                            South Bangalore. The project is just 5 Minutes away from Royal Meenakshi Mall, Decathlon,
                            Christ University & Narayana Nethralaya Eye Hospital. And, Just 10 Minutes from IIM
                            Bangalore, Fortis Hospital & Apollo Hospital. Vega City Mall is just 15 minutes drive from
                            the project.
                        </p>
                        <p>
                            <b>Amenities</b> : Villas at Raj Viviente come with 20+ World-Class Amenities, Ultra Modern
                            Clubhouse & Lush Green Open Spaces. The project offers top of the line amenities such as
                            Heated Pool & Pool Deck, Jacuzzi, Toddlers Pool, Squash Court, Multipurpose Court, His & Her
                            Spa, Dribble Court, Banquet Hall, Party Lawn, Indoor Games Room, Gymnasium, Badminton Court,
                            Steam & Sauna, Cricket Practice Net, Barbeque / Bar, Yoga & Aerobics Room, Amphitheatre,
                            Outdoor Seating Area, Pantry, Massage Centres & more.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-md-10 col-sm-12">
                        <table class="tg" border="1" cellspacing="0" style="max-width:800px;margin:auto;">
                            <tbody>
                                <tr>
                                    <th class="tg-baqh" colspan="3"><b>Raj Viviente by SNN Raj Corp</b><br><b>Luxury 4BHK
                                            Villas Off Bannerghatta Rd</b><br><br><b
                                ...
                                <tr>
                                    <td class="tg-0lax"><b>4BHK<br>(West Facing)</b></td>
                                    <td class="tg-0lax"><b>Type 1<br>2100 Sft Plot</b></td>
                                ...
                                <tr>
                                    <td class="tg-0lax"><b>4BHK<br>(East Facing)</b></td>
                                    <td class="tg-0lax"><b>Type 2<br>2100 Sft Plot</b></td>
                                    <td class="tg-0lay locked" style="display:table-cell;"><button
                                            class="unlockbuttonstyler"
                                            style="background-color: black !important; background-image: linear-gradient(315deg,#000000 0%,#191919 74%); color: white;font-weight:bold;"
                                            type="button"
                                ...
                                <tr>
                                    <td class="tg-0lax"><b>4BHK<br>(East Facing)</b></td>
                                    <td class="tg-0lax"><b>Type 3<br>(2 views)<br>2100 Sft Plot</b></td>
                                    <td class="tg-0lay locked" style="display:table-cell;"><button
                                            class="unlockbuttonstyler"
                                            style="background-color: black !important; background-image: linear-gradient(315deg,#000000 0%,#191919 74%); color: white;font-weight:bold;"
                                            type="button"
                                ...
                                <tr>
                                    <td class="tg-0lax"><b>4BHK<br>(East Facing)</b></td>
                                    <td class="tg-0lax"><b>Type 5<br>(3 views)<br>2100 Sft Plot</b></td>
                                    <td class="tg-0lay locked" style="display:table-cell;"><button
                                            style="background-color: black !important; background-image: linear-gradient(315deg,#000000 0%,#191919 74%); color: white;font-weight:bold;"
            ...
            <div class="container">
                ...
                <div class="row mt-5 justify-sm-around">
                    <div class="col-lg-4 col-md-6 col-sm-12 amenities-col">
                        <img src="assets/rajhighgardens/images/icons/1.png" alt="">
                        <p>Ultra Luxury 4BHK(G+2 Floors) Villas With Private Backyard Garden</p>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 amenities-col">
                        <img src="assets/rajhighgardens/images/icons/2.png" alt="">
                        <p>Double Height Ceiling, 18 Ft Tall Windows, Elevator Provision, Double Car Park, Global
                            Fixtures</p>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 amenities-col">
                        <img src="assets/rajhighgardens/images/icons/3.png" alt="">
                        <p>Located Off Bannerghatta Road Just 5 Minutes From Royal Meenakshi Mall & Christ University
                        </p>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 amenities-col">
                        <img src="assets/rajhighgardens/images/icons/4.png" alt="">
                        <p>Narayana Nethralaya is just 5 Minutes and Fortis & Apollo Hospitals are 10 Minutes away</p>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 amenities-col">
                        <img src="assets/rajhighgardens/images/icons/5.png" alt="">
                        <p>Nice Road Junction & Pink Line Metro Station are just 5 Minutes away</p>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 amenities-col">
                        <img src="assets/rajhighgardens/images/icons/6.png" alt="">
                        <p>Excellent Connectivity to E-City, JP Nagar, Uttarahalli, HSR Layout, Sarjapur Rd, RR nagar &
                            Mysore Rd</p>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 amenities-col">
                        <img src="assets/rajhighgardens/images/icons/7.png" alt="">
                        <p>64 Exquisite 4BHK Homes With 3891 Sqft Super Built-up Area & 2100 Sqft Plot Area</p>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 amenities-col">
                        <img src="assets/rajhighgardens/images/icons/8.png" alt="">
                        <p>Ultra Modern Clubhouse, 20+ World Class Amenities & Lush Green Open Spaces</p>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 amenities-col">
                        <img src="assets/rajhighgardens/images/icons/9.png" alt="">
                        <p>Heated Pool & Pool Deck, Jacuzzi, Toddlers Pool, Squash Court, Badminton Court, Steam &
                            Sauna, Cricket Nets & More</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer>
        <div class="main-footer">
            <div class="container">
                <img src="assets/rajhighgardens/images//white-main-logo.png" alt="">
                <div class="row">
...
<script src="assets/rajhighgardens/js/jquery.js"></script>
<script src="assets/rajhighgardens/js/bootstrap.min.js"></script>
<script src="assets/rajhighgardens/js/tabs.js"></script>
<script src="assets/rajhighgardens/js/img-previewer.js"></script>
<script src="assets/rajhighgardens/js/slick.js"></script>
<script src="assets/rajhighgardens/js/iziToast.min.js"></script>
<script src="assets/rajhighgardens/js/jquery.validate.min.js"></script>
